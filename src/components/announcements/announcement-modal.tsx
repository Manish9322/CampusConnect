...
export function AnnouncementModal({ isOpen, onOpenChange, announcement }: AnnouncementModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent 
        className="font-chalkboard bg-[#2C3E50] text-white border-4 border-[#a07a56] shadow-[0_0_20px_rgba(235,225,202,0.4),_inset_0_0_10px_rgba(0,0,0,0.5)] p-8 max-w-2xl"
