...
export const mockStudents: Student[] = [
  { id: '1', studentId: 'S001', name: 'Alice Johnson', email: 'alice@example.com', role: 'student', major: 'Computer Science', phone: '202-555-0182', status: 'active', attendancePercentage: 95 },
  { id: '2', studentId: 'S002', name: 'Bob Williams', email: 'bob@example.com', role: 'student', major: 'Physics', phone: '202-555-0191', status: 'active', attendancePercentage: 88 },
  { id: '3', studentId: 'S003', name: 'Charlie Brown', email: 'charlie@example.com', role: 'student', major: 'Mathematics', phone: '202-555-0143', status: 'inactive', attendancePercentage: 74 },
  { id: '4', studentId: 'S004', name: 'Diana Miller', email: 'diana@example.com', role: 'student', major: 'Computer Science', phone: '202-555-0123', status: 'active', attendancePercentage: 98 },
  { id: '5', studentId: 'S005', name: 'Eve Davis', email: 'eve@example.com', role: 'student', major: 'Chemistry', phone: '202-555-0187', status: 'active', attendancePercentage: 82 },
  { id: '6', studentId: 'S006', name: 'Frank White', email: 'frank@example.com', role: 'student', major: 'Computer Science', phone: '202-555-0165', status: 'inactive', attendancePercentage: 65 },
  { id: '7', studentId: 'S007', name: 'Grace Hall', email: 'grace@example.com', role: 'student', major: 'Physics', phone: '202-555-0154', status: 'active', attendancePercentage: 91 },
];
