...
const formSchema = z.object({
  ...
  category: z.enum(['General', 'Event', 'Academic', 'Urgent']),
...
const categories: AnnouncementCategory[] = ['General', 'Event', 'Academic', 'Urgent'];
...
export function AddAnnouncementDialog({
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    onSave(values);
    toast({
      title: announcementData ? "Announcement Updated" : "Announcement Added",
      description: `The announcement "${values.title}" has been successfully ${announcementData ? 'updated' : 'added'}.`,
    });
    onOpenChange(false);
  };
