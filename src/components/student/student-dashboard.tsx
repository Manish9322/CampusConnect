       ...
       <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
                ...
                <CardContent><p className="text-4xl font-bold">{totalClasses}</p></CardContent>
            </Card>
            <Card>
                <CardHeader><CardTitle>Days Present</CardTitle></CardHeader>
                <CardContent><p className="text-4xl font-bold text-green-600">{presentDays}</p></CardContent>
            </Card>
            <Card>
                <CardHeader><CardTitle>Days Absent</CardTitle></CardHeader>
